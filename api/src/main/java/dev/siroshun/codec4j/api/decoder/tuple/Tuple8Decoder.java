...
record Tuple8Decoder<T, V1, V2, V3, V4, V5, V6, V7, V8>(Function8<V1, V2, V3, V4, V5, V6, V7, V8, T> constructor,
                                                        ...
                                                        TupleValueDecoder<V8> decoder8) implements Decoder<T> {
    ...
    public @NotNull Result<T, DecodeError> decode(@NotNull In in) {
        ...
        return Result.success(this.constructor.apply(v1Result.unwrap(), v2Result.unwrap(), v3Result.unwrap(), v4Result.unwrap(), v5Result.unwrap(), v6Result.unwrap(), v7Result.unwrap(), v8Result.unwrap()));
    }
}
