...
record FieldList5<T, F1, F2, F3, F4, F5>(FieldCodec<T, F1> codec1, FieldCodec<T, F2> codec2, FieldCodec<T, F3> codec3, FieldCodec<T, F4> codec4, FieldCodec<T, F5> codec5, Function5<F1, F2, F3, F4, F5, T> constructor) implements Supplier<ObjectCodec.ObjectConstructor<T>> {
