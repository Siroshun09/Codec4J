...
record FieldList4<T, F1, F2, F3, F4>(FieldCodec<T, F1> codec1, FieldCodec<T, F2> codec2, FieldCodec<T, F3> codec3, FieldCodec<T, F4> codec4, Function4<F1, F2, F3, F4, T> constructor) implements Supplier<ObjectCodec.ObjectConstructor<T>> {
