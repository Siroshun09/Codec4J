...
record Tuple9Decoder<T, V1, V2, V3, V4, V5, V6, V7, V8, V9>(Function9<V1, V2, V3, V4, V5, V6, V7, V8, V9, T> constructor,
                                                            ...
                                                            TupleValueDecoder<V9> decoder9) implements Decoder<T> {
