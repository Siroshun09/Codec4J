...
record FieldList10<T, F1, F2, F3, F4, F5, F6, F7, F8, F9, F10>(FieldDecoder<F1> codec1, FieldDecoder<F2> codec2, FieldDecoder<F3> codec3, FieldDecoder<F4> codec4, FieldDecoder<F5> codec5, FieldDecoder<F6> codec6, FieldDecoder<F7> codec7, FieldDecoder<F8> codec8, FieldDecoder<F9> codec9, FieldDecoder<F10> codec10, Function10<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10, T> constructor) implements Supplier<ObjectDecoder.ObjectConstructor<T>> {
